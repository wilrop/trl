...
class GRPOTrainerTester(unittest.TestCase):
    ...
    def test_training_with_eval_from_iterable(self):
        train_dataset = load_dataset("trl-internal-testing/zen", "standard_prompt_only", split="train").to_iterable_dataset()
        eval_dataset = load_dataset("trl-internal-testing/zen", "standard_prompt_only", split="test").to_iterable_dataset()
